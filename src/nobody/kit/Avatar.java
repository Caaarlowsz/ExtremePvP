...
/*     */ {
	...
	/*     */ public void Trocar(PlayerInteractEvent e) {
		...
		/* 72 */ if (((e.getAction() == Action.RIGHT_CLICK_AIR) || (e.getAction() == Action.RIGHT_CLICK_BLOCK))
			...
			/* 75 */ } else if ((Ferro.contains(p.getName()))
					&& ((e.getAction() == Action.LEFT_CLICK_AIR) || (e.getAction() == Action.LEFT_CLICK_BLOCK))
					&& (KitAPI.getkit(p) == "Avatar") && (p.getItemInHand().equals(AR))) {
			/* 76 */ p.setItemInHand(Agua);
			/* 77 */ Ferro.remove(p.getName());
			/* 78 */ Avatar2.add(p.getName());
			/* 79 */ } else if ((Avatar2.contains(p.getName()))
					&& ((e.getAction() == Action.LEFT_CLICK_AIR) || (e.getAction() == Action.LEFT_CLICK_BLOCK))
					&& (KitAPI.getkit(p) == "Avatar") && (p.getItemInHand().equals(Agua))) {
			/* 80 */ p.setItemInHand(Terra);
			/* 81 */ Avatar2.remove(p.getName());
			/* 82 */ Terras.add(p.getName());
			/* 83 */ } else if ((Terras.contains(p.getName())) && (Terras.contains(p.getName()))
					&& ((e.getAction() == Action.LEFT_CLICK_AIR) || (e.getAction() == Action.LEFT_CLICK_BLOCK))
					&& (KitAPI.getkit(p) == "Avatar") && (p.getItemInHand().equals(Terra))) {
			/* 84 */ p.setItemInHand(Fogo);
			/* 85 */ Terras.remove(p.getName());
			/* 86 */ Red.add(p.getName());
			//
			/*     */ }
		/* 88 */ else if ((Red.contains(p.getName()))
				&& ((e.getAction() == Action.LEFT_CLICK_AIR) || (e.getAction() == Action.LEFT_CLICK_BLOCK))
				&& (KitAPI.getkit(p) == "Avatar") &&
	...
	/*     */ {
		...
		/* 101 */ if ((Ferro.contains(p.getName()))
	...
	/*     */ {
		...
		/*     */ {
			...
			/*     */ {
				...
				/* 160 */ ((LivingEntity) Tomou2).addPotionEffect(
						new org.bukkit.potion.PotionEffect(org.bukkit.potion.PotionEffectType.BLINDNESS, 100, 0), true);
				/*     */ }
			/*     */ }
		/*     */ }
	...
	/*     */ {
		...
		/* 169 */ if ((Avatar2.contains(p.getName()))
				&& ((event.getAction() == Action.RIGHT_CLICK_AIR) || (event.getAction() == Action.RIGHT_CLICK_BLOCK))
				&& (KitAPI.getkit(p) == "Avatar") &&
	...
	/*     */ {
		...
		/*     */ {
			...
			/*     */ {
				...
				/* 228 */ ((LivingEntity) Tomou2).addPotionEffect(
						new org.bukkit.potion.PotionEffect(org.bukkit.potion.PotionEffectType.POISON, 300, 0), true);
				/*     */
	...
	/*     */ {
		...
		/* 309 */ if ((Terras.contains(p.getName()))
				&& ((event.getAction() == Action.RIGHT_CLICK_AIR) || (event.getAction() == Action.RIGHT_CLICK_BLOCK))
				&& (KitAPI.getkit(p) == "Avatar") &&
 ...
 * plugins\MasterKits.jar!\Kits\Avatar.class Java compiler version: 7 (51.0)
