...
/*     */ {
	...
	/*     */ public void VelotrolClick(PlayerInteractEvent e) {
		...
		/* 36 */ if ((e.getPlayer().getItemInHand().getType() == Material.REDSTONE_BLOCK)
				&& (KitAPI.getkit(p) == "Deshfire")) {
			/* 37 */ if ((e.getAction() == Action.LEFT_CLICK_AIR) || (e.getAction() == Action.LEFT_CLICK_BLOCK)
			...
			/* 47 */ p.getPlayer().getWorld().playEffect(p.getPlayer().getLocation(),
					org.bukkit.Effect.MOBSPAWNER_FLAMES, 10, 0);
			p.getLocation();
	...
	/*     */ public void onPlayerDamageSponge(EntityDamageEvent e) {
		...
		/* 111 */ if ((e.getCause() == org.bukkit.event.entity.EntityDamageEvent.DamageCause.FALL)
 ...
 * plugins\MasterKits.jar!\Kits\Deshfire.class Java compiler version: 7 (51.0)
