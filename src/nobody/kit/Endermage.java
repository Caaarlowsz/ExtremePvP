...
/*     */ {
	...
	/*     */ {
		/* 46 */ return (Math.abs(portal.getX() - player.getX()) < 3.0D)
					...
					/*     */ public void run() {
						...
						/* 81 */ (!target.isDead())) {
							...
							/* 87 */ (KitAPI.getkit(mage) == "Endermage")) {
								/* 88 */ mage.getInventory()
										.addItem(new ItemStack[] { new ItemStack(Material.PORTAL) });
 ...
 * plugins\MasterKits.jar!\Kits\Endermage.class Java compiler version: 7 (51.0)
