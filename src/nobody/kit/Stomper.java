...
/*    */ {
	...
	/*    */ {
		...
		/* 63 */ (KitAPI.getkit(p) == "Stomper")) {
			...
			/* 80 */ cooldownm.add(p);
			/* 81 */ org.bukkit.Bukkit.getScheduler().scheduleSyncDelayedTask(nobody.main.Main.getInstance(),
					new Runnable()
					/*    */ {
						/*    */ public void run()
						/*    */ {
 ...
 * plugins\MasterKits.jar!\Kits\Stomper.class Java compiler version: 7 (51.0)
