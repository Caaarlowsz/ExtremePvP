...
/*    */ {
	...
	/*    */ public void landed(PlayerMoveEvent e) {
		/* 49 */ if ((e.getPlayer().getLocation().getBlock().getRelative(org.bukkit.block.BlockFace.DOWN)
 ...
 * plugins\MasterKits.jar!\Kits\Kangaroo.class Java compiler version: 7 (51.0)
