...
public class Motd implements Listener {
	...
	public void onPlayer(PlayerMoveEvent e) {
		...
		if ((!this.mecheu.contains(p.getName()))
			...
			p.sendMessage(
					" §l§6» §eParabens Voce Concluiu o Nivel Facil do LavaChallenge e Por isso Recebeu §6400 §eCOINS !");
	...
	public void onPlayer1(PlayerMoveEvent e) {
		...
		if ((!this.mecheu.contains(p.getName()))
			...
			p.sendMessage(
					" §l§6» §eParabens Voce Concluiu o Nivel Medio do LavaChallenge e Por isso Recebeu §61000 §eCOINS !");
		}
	}
	...
	public void onPlayer11(PlayerMoveEvent e) {
		...
		if ((!this.mecheu.contains(p.getName()))
			...
			p.sendMessage(
					" §l§6» §eParabens Voce Concluiu o Nivel Dificil do LavaChallenge e Por isso Recebeu §62000 §eCOINS !");
		}
	}
	...
	public void onPlayer111(PlayerMoveEvent e) {
		...
		if ((!this.mecheu.contains(p.getName()))
			...
			p.sendMessage(
					" §l§6» §eParabens Voce Concluiu o Nivel Extreme do LavaChallenge e Por isso Recebeu §6300 §eCOINS + Kit ->");
		}
		{
		}
	}
