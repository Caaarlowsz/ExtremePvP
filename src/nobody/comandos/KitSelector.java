...
/*     */ {
	...
	/*     */ {
		...
		/* 485 */ kangaroometa.setLore(
				Lore("§7Esse §7kit §7você §7tem §7habilidade §7de §7sair §7dando §7pulos §7igual §7um §7Canguru"));
		...
		/* 491 */ archermeta
				.setLore(Lore("§7Esse §7kit §7você §7recebe §7um §7arco §7e §7uma §7flecha §7para §7dar §7Head-Shot "));
		...
		/* 497 */ vipermeta.setLore(
				Lore("§7Esse §7kit §7você §7tem §725% §7de §7chance §7para §7dar §7poison §7em §7seu §7inimigo  "));
		...
		/* 503 */ snailmeta.setLore(Lore(
				"§7Esse §7kit §7você §7tem §725% §7de §7chance §7para §7deixar §7seu §7inimigo §7com §7lentidão "));
		...
		/* 509 */ fishermanmeta
				.setLore(Lore("§7Esse §7kit §7você §7tem §7a §7habilidade §7de §7poder §7puxar §7seu §7inimigo "));
		...
		/* 515 */ stompermeta
				.setLore(Lore("§7Esse §7kit §7você §7tem §7a §7habilidade §7de §7poder §7esmagar §7seu §7inimigo "));
		...
		/* 521 */ vikingmeta.setLore(Lore(
				"§7Esse §7kit §7você §7tem §7a §7habilidade §7de §7poder §7dar §7mais §7dano §7com §7seu §7machado "));
		...
		/* 527 */ ninjameta.setLore(Lore(
				"§7Esse §7kit §7você §7tem §7a §7habilidade §7de §7poder §7teleportar §7para §7o §7ultimo §7player §7que §7você §7bateu "));
		...
		/* 533 */ specialistmeta.setLore(Lore(
				"§7Esse §7kit §7você §7tem §7a §7habilidade §7de §7poder §7encantar §7seus §7itens §7ganhando §7XP §7ao §7matar §7um §7player "));
		...
		/* 539 */ turtlemeta.setLore(Lore(
				"§7Esse §7kit §7você §7tem §7a §7habilidade §7de §7quando §7o §7player §7inimigo §7te §7bater §7e §7você §7estiver §7agaixado §7você §7tomará §7menos §7dano "));
		...
		/* 546 */ grandpameta.setLore(Lore(
				"§7Esse §7kit §7você §7tem §7uma §7varinha §7magica §7onde §7você §7pode §7lançar §7seu §7inimigo §7longe "));
		...
		/* 582 */ lavamanmeta.setLore(Lore(
				"§7Ganhe §7velocidade §7e §7força §7quando §7interagir §7com §7lava, §7porÃ©m §7quando §7interagir §7com §7água §7levará §7dano"));
		...
		/* 618 */ switchermeta
				.setLore(Lore("§7Jogue §7uma §7Bolinha §7de §7Neve §7e §7se §7teleporte §7para §7o §7outro §7player"));
		...
		/* 642 */ firemanmeta.setLore(Lore(
				"§7Quando §7você §7entrar §7em §7combate §7com §7outro §7jogador, §7ele §7tomará §7dano §7de §7fogo"));
		...
		/* 660 */ reapermeta.setLore(Lore(
				"§7Clique §7com §7o §7botão §7direito §7com §7sua §7foiçe §7em §7outros §7player §7e §7de §7efeito §7Wither"));
		...
		/* 666 */ ryumeta
				.setLore(Lore("§7Jogue §7uma §7bolinha §7de §7neve §7e §7de §7efeitos §7em §7outros §7player "));
		...
		/* 672 */ jellyfishmeta
				.setLore(Lore("§7Coloque §7uma §7agua §7no §7chão §7e §7deixe §7seus §7inimigos §7com §7Poison "));
		...
		/* 678 */ c4meta
				.setLore(Lore("§7Implante §7uma §7bomba §7e §7explode §7com §7os §7orgãos §7de §7outros §7jogadores "));
		...
		/* 695 */ deshfiremeta.setLore(Lore(
				"§7Taque §7fogo §7em §7seu §7inimigo §7clicando §7com §7o §7botão §7direito §7em §7cima §7do §7bloco §7de §7Redstone "));
		...
		/* 707 */ criticalmeta
				.setLore(Lore("§7Tenha §733% §7de §7chance §7de §7dar §7um §7golpe §7critico §7em §7seu §7inimigo"));
		...
		/* 713 */ thormeta
				.setLore(Lore("§7Sinta-se §7o §7thor §7e §7mande §7raios §7na §7cabeça §7dos §7seus §7inimigos"));
		...
		/* 776 */ if (p.hasPermission("kit.viper")) {
			...
			/*     */ }
		/* 780 */ if ((Main.getInstance().loja.getString(p.getName().toLowerCase() + ".Snail").equals("true"))
				|| (p.hasPermission("kit.snail"))) {
		...
		/* 784 */ if (p.hasPermission("kit.fisherman")) {
			...
			/*     */ }
		/* 788 */ if ((Main.getInstance().loja.getString(p.getName().toLowerCase() + ".Stomper").equals("true"))
		...
		/* 832 */ if (p.hasPermission("kit.lavaman")) {
			...
			/*     */ }
		/* 836 */ if ((Main.getInstance().loja.getString(p.getName().toLowerCase() + ".Anchor").equals("true"))
				|| (p.hasPermission("kit.anchor"))) {
			/* 837 */ kit.removeItem(new ItemStack[] { vidro });
			/* 838 */ kit.addItem(new ItemStack[] { anchor });
			/*     */ }
		/* 840 */ if ((Main.getInstance().loja.getString(p.getName().toLowerCase() + ".Camel").equals("true"))
				|| (p.hasPermission("kit.camel"))) {
		...
		/* 864 */ if (p.hasPermission("kit.bomber")) {
			...
			/*     */ }
		/* 868 */ if ((Main.getInstance().loja.getString(p.getName().toLowerCase() + ".Endermage").equals("true"))
				|| (p.hasPermission("kit.endermage"))) {
 ...
 * plugins\MasterKits.jar!\Gui\KitSelector.class Java compiler version: 7 (51.0)
