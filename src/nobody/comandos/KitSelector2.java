...
/*     */ {
	...
	/*     */ {
		...
		/* 81 */ if ((e.getMaterial() == Material.CARPET) && (e.getItem().getType() == Material.CARPET)
				&& (KitAPI.getkit(p) == "Nenhum")) {
			/* 82 */ p.chat("/kits2");
			/*     */ }
		/*     */ }
	...
	/*     */ {
		...
		/* 200 */ avatarmeta
				.setLore(Lore("§7Veja §7como §7ser §7o §7avatar §7e §7jogue §7poderes §bAgua §cFogo §7§lAR e §6Terra"));
		...
		/* 206 */ rainmeta.setLore(
				Lore("§7Nao §7deixe §7seu §7inimigo §7fugir §7lançe §7uma §7chuvarada §7de §7flechas §7e §7o §7mate"));
		...
		/* 239 */ if (p.hasPermission("kit.phantom")) {
			...
			/*     */ }
		/*     */
		/* 244 */ if ((Main.getInstance().loja.getString(p.getName().toLowerCase() + ".Avatar").equals("true"))
				|| (p.hasPermission("kit.avatar"))) {
			/* 245 */ kit.removeItem(new ItemStack[] { vidro });
			/* 246 */ kit.addItem(new ItemStack[] { avatar });
			/*     */ }
		/*     */
		/* 249 */ if ((Main.getInstance().loja.getString(p.getName().toLowerCase() + ".Rain").equals("true"))
				|| (p.hasPermission("kit.rain"))) {
		...
		/* 928 */ if (p.hasPermission("kit.ebola")) {
			...
			/*     */ }
		/* 932 */ if ((Main.getInstance().loja.getString(p.getName().toLowerCase() + ".ForceField").equals("true"))
				|| (p.hasPermission("kit.forcefield"))) {
 ...
 * plugins\MasterKits.jar!\Gui\KitSelector2.class Java compiler version: 7
